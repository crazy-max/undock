...
// https://github.com/containers/image/pull/2120
replace github.com/containers/image/v5 => github.com/crazy-max/containers-image/v5 v5.12.1-0.20230915184351-9e958409c40c
